...
pub enum Msg {
    Single(Single),
    Group(Single),
    SingleVideoOffer(Offer),
    SingleVideoInvite(InviteMsg),
    SingleInviteAnswer(InviteAnswerMsg),
    SingleInviteCancel(InviteCancelMsg),
    SingleVideoAgree(Agree),
    SingleNotAnswer(InviteNotAnswerMsg),
    SingleVideoHangUp(Hangup),
